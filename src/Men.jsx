...
//           />
//         )}
//         <span className="tag tag-new">Men</span>
...
//         <p className="card-desc">Men's Clothing</p>
...
//         </div>
//         <button className="btn-add men-btn" type="button">
...
//   return (
//     <div className="product-page men-page">
//       <div className="pg-bg" aria-hidden="true">
//         <div className="pg-orb orb-1" />
//         <div className="pg-orb orb-2" />
//         <div className="pg-dots" />
//       </div>
//       <header className="pg-header">
//         <div className="pg-eyebrow">
//           <span className="eyebrow-accent men-accent" /> Men's Collection
//         </div>
//         <h1 className="pg-title">
//           Dress <span className="pg-highlight men-hl">Sharp.</span>
//         </h1>
//         <p className="pg-sub">
//           Curated menswear — from boardroom to streetwear.
//         </p>
